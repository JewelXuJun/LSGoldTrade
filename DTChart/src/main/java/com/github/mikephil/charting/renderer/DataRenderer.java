...
public abstract class DataRenderer extends Renderer {
    ...
    protected Paint mHighlightTextBgPaint;
...
//        mHighlightPaint.setStyle(Style.STROKE);
        ...
        mHighlightPaint.setTextSize(Utils.convertDpToPixel(12f));//Modify:用于画HightLight对应的Y值 by Yanmin
        mHighlightPaint.setColor(Color.WHITE);//Color.rgb(255, 187, 115)

        mHighlightTextBgPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
//        mHighlightTextBgPaint.setStyle(Style.STROKE);
        mHighlightPaint.setStrokeWidth(2f);
        mHighlightTextBgPaint.setColor(Color.BLACK);
    }
