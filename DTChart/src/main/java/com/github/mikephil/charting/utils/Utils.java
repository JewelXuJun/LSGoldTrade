...
public abstract class Utils {
    ...
    // Modify By yanmin: Returns SelectionDetail that contains the closest value on the y-axis
    public static SelectionDetail getClosestSelectionDetail(List<SelectionDetail> valsAtIndex, float val,
                                             AxisDependency axis) {

        SelectionDetail index = null;
        float distance = Float.MAX_VALUE;
