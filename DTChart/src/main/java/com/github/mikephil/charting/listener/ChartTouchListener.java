...
public abstract class ChartTouchListener<T extends Chart<?>> extends GestureDetector.SimpleOnGestureListener implements View.OnTouchListener {
    ...
    public void setSecondChart(T chartSecond) {
        mChartSecond = chartSecond;
    }
    /**
    ...
    public void endAction(MotionEvent me) {
        //Modify by hualei: 当调用onChartGestureEnd方法时，阻止外层onTouch事件的调用
    ...
    protected void performHighlightSecond(Highlight h, MotionEvent e) {

        if (h == null || h.equalTo(mLastHighlightedSecond)) {
            mChartSecond.highlightTouch(null);
            mLastHighlightedSecond = null;
        } else {
