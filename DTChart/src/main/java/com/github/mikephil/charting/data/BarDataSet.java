...
// Modify by yanmin: 把继承BarLineScatterCandleBubbleDataSet改成继承LineScatterCandleRadarDataSet，支持HighLight以画线形式来表现
public class BarDataSet extends LineScatterCandleRadarDataSet<BarEntry> {
