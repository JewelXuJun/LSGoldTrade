...
public class ElectronicCardAdapter extends BaseQuickAdapter<InOutTurnOverVo.TurnOverBean, BaseViewHolder> {

    private Context mContext;

    public ElectronicCardAdapter(Context context, int layoutResId, @Nullable List<InOutTurnOverVo.TurnOverBean> data) {
