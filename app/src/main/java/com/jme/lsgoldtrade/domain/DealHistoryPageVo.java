...
public class DealHistoryPageVo implements Serializable {
    ...
    private List<DealHistoryBean> list;
    ...
    public List<DealHistoryBean> getList() {
        return list;
    }

    public void setList(List<DealHistoryBean> list) {
        this.list = list;
    }

    public static class DealHistoryBean implements Serializable{
        /**
