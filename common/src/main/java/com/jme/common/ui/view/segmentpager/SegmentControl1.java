package com.jme.common.ui.view.segmentpager;
 ...
 */
public class SegmentControl1 extends View {
    ...
    public SegmentControl1(Context context) {
        this(context, null);
    }

    public SegmentControl1(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SegmentControl1(Context context, AttributeSet attrs, int defStyle) {
