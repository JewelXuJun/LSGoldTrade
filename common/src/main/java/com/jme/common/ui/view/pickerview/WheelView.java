...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
        super(context, attrs);
        textColorOut = getResources().getColor(R.color.pickerview_text_out);
        textColorCenter = getResources().getColor(R.color.pickerview_text_center);
    ...
    private void initPaints() {
        ...
        paintCenterRightText = new Paint();
        paintCenterRightText.setColor(textColorCenterRight);
        paintCenterRightText.setAntiAlias(true);
        paintCenterRightText.setTextScaleX(1.1F);
        paintCenterRightText.setTypeface(Typeface.MONOSPACE);
        paintCenterRightText.setTextSize(textSize);
        paintCenterRightText.setFakeBoldText(true);
    ...
    public final void setAdapter(PickAdapter adapter) {
        this.adapter = adapter;
        remeasure();
        invalidate();
    }

    public final PickAdapter getAdapter() {
        return adapter;
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        while (counter < itemsVisible) {
            ...
            if (angle >= 90F || angle <= -90F) {
                ...
                String[] strs = getTextTwoStrs(contentText);
                ...
                if (translateY <= firstLineY && maxTextHeight + translateY >= firstLineY) {
                    ...
                    canvas.drawText(strs[0], drawOutContentStart, maxTextHeight, paintOuterText);

                    Rect rect = new Rect();
                    paintOuterText.getTextBounds(strs[0], 0, strs[0].length(), rect);

                    canvas.drawText(strs[1], drawOutContentStart + rect.width() + 50, maxTextHeight, paintCenterRightText);
                    ...
                    canvas.drawText(strs[0], drawCenterContentStart, maxTextHeight - CENTERCONTENTOFFSET, paintCenterText);

                    Rect rect2 = new Rect();
                    paintCenterText.getTextBounds(strs[0], 0, strs[0].length(), rect2);

                    canvas.drawText(strs[1], drawCenterContentStart + rect2.width() + 50, maxTextHeight - CENTERCONTENTOFFSET, paintCenterRightText);
                    ...
                    Rect rect = new Rect();
                    paintCenterText.getTextBounds(strs[0], 0, strs[0].length(), rect);

                    canvas.drawText(strs[1], drawCenterContentStart + rect.width() + 50, maxTextHeight - CENTERCONTENTOFFSET, paintCenterRightText);
                    ...
                    Rect rect2 = new Rect();
                    paintOuterText.getTextBounds(strs[0], 0, strs[0].length(), rect2);

                    canvas.drawText(strs[1], drawOutContentStart + rect2.width() + 50, maxTextHeight, paintCenterRightText);
    ...
    private String[] getTextTwoStrs(String value) {
        ...
        strs[0] = value.substring(0, index);
        strs[1] = value.substring(index + space.length(), value.length());
