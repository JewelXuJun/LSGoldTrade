package com.jme.common.ui.view.nicespinner;
...
public class NiceSpinner extends TextView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        setBackgroundResource(R.drawable.selector_status_bg);
        textColor = typedArray.getColor(R.styleable.NiceSpinner_textTint, -1);
        setTextColor(textColor);


        LayoutInflater inflater = LayoutInflater.from(context);
        View root_layout =inflater.inflate(R.layout.popwin_spinner_layout,null);
        listView = (ListView) root_layout.findViewById(R.id.spinner_list);
...
//        listView.setId(getId());
        ...
        popupWindow.setContentView(root_layout);
    ...
    public void setAdapter(@NonNull NiceSpinnerAdapterWrapper adapter) {
