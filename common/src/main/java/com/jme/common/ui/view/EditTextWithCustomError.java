...
public class EditTextWithCustomError extends EditText {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (a.hasValue(R.styleable.EditTextWithCustomError_ErrorTextColor)) {
            mErrorTextColor = a.getColor(R.styleable.EditTextWithCustomError_ErrorTextColor, Color.RED);
        }
    }
...
//			LayoutInflater inflater = LayoutInflater.from(getContext());
        ...
        mPopup.showAsDropDown(this, getErrorX(), getErrorY()*3);
    ...
    private void chooseSize(PopupWindow pop, CharSequence text, TextView tv) {
        ...
        if (cap < 0) {
            cap = 200; // We must not be measured yet -- setFrame() will fix it.
                                                         ...
                                                         // 换行宽度
        Layout l = new StaticLayout(text, tv.getPaint(), 800,
